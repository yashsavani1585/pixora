...
//           <div className="w-[500px] sm:w-[540px] md:w-[700px] lg:w-[500px] aspect-square relative">
//             <RotatingCircle />
//           </div>
//         </div>
...
const ExpertsSection = () => {
  return (
    <section className="bg-white py-14 md:py-20 px-4 sm:px-6 lg:px-20">
      <div className="flex flex-col md:flex-row items-center justify-center gap-12 lg:gap-20">
        ...
        {/* Right Side - Content */}
        <div className="w-full md:w-1/2 max-w-2xl text-center md:text-left flex flex-col justify-center">
          <p className="uppercase text-sm font-semibold text-gray-500 tracking-wide">
            We're a creative bunch
          </p>
