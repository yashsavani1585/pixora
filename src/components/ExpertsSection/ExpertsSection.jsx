...
const ExpertsSection = () => {
  return (
    <section className="bg-white py-8 md:py-12 px-4 sm:px-1 md:px-12 lg:px-20 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-8">
      ...
      {/* Right Side - Content */}
      <div className="w-full md:w-1/2 max-w-xl text-center md:text-left sm:py-14">
