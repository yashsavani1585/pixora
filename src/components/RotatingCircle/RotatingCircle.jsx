...
//         ref={containerRef}
//         className="relative 
//   w-[250px] sm:w-[700px] md:w-[600px] lg:w-[600px] xl:w-[600px] 
//   aspect-square"
//       >
//         {/* Central Circle */}
//         <div className="absolute inset-0 flex items-center  justify-center z-30">
...
// Inner orbit (3 icons)
const innerOrbitIcons = [{ src: xd }, { src: Ai }, { src: node }];

// Outer orbit (4 icons)
const outerOrbitIcons = [{ src: react }, { src: js }, { src: shopify }, { src: wp }];
  ...
  return (
    <div className="flex items-center justify-center">
      <div
        ref={containerRef}
        className="relative 
    w-[330px] sm:w-[400px] md:w-[520px] lg:w-[650px] xl:w-[720px] 
    aspect-square"
      >

        {/* Central Logo Circle */}
        <div className="absolute inset-0 flex items-center justify-center z-30">
          <div className="w-14 h-14 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full bg-white border-2 border-black flex items-center justify-center">
            <img src={logo} alt="Pixora Logo" className="w-8 h-8 sm:w-12 sm:h-12 md:w-16 md:h-16" />
          </div>
        </div>

        {/* Outer Circle Border */}
        <div className="absolute inset-[6%] rounded-full border border-black"></div>
        <div className="absolute inset-[22%] rounded-full border border-black"></div>
        ...
        >
          {innerOrbitIcons.map((icon, index) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-white shadow-lg flex items-center justify-center border border-gray-300">
                  <img src={icon.src} alt="" className="w-7 h-7 sm:w-9 sm:h-9 md:w-10 md:h-10" />
                </div>
              </div>
            );
          })}
        ...
        >
          {outerOrbitIcons.map((icon, index) => {
            ...
            return (
              ...
              >
                <div className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-full bg-white shadow-md flex items-center justify-center border border-gray-300">
                  <img src={icon.src} alt="" className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12" />
                </div>
              </div>
            );
          })}
